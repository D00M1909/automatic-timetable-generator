...
// ============================
// HANDLE ALL POST ACTIONS (unchanged)
// ============================
...
<head>
    ...
    <style>
        ...
        .section-body { padding: 24px; transition: max-height 0.4s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.3s ease, padding 0.3s ease; max-height: 5000px; opacity: 1; overflow: hidden; }
        .section-body.collapsed { max-height: 0; opacity: 0; padding: 0 24px; }
        ...
        .btn-submit { margin-top: 8px; padding: 10px 24px; border-radius: 8px; font-weight: 600; font-size: 13px; display: inline-flex; align-items: center; gap: 8px; transition: all 0.2s; border: none; cursor: pointer; }
        ...
        .data-table { max-height: 320px; overflow-y: auto; border-radius: 8px; border: 1px solid #eee; }
...
<body>
    ...
    <div class="content-wrapper">
                ...
                <div class="data-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <button class="action-btn edit" onclick="toggleEdit('year-edit-<?php echo $row['year_id']; ?>')">
                        ...
                        <tr><td colspan="4" style="padding:0;">
                            <div id="year-edit-<?php echo $row['year_id']; ?>" class="edit-form">
                                ...
                                <form method="POST">
                                    ...
                                    <button type="submit" class="btn btn-submit" style="background:#3498db; color:white;">
                ...
                <div class="data-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <button class="action-btn edit" onclick="toggleEdit('class-edit-<?php echo $row['class_id']; ?>')">
                                    <svg viewBox="0 0 24 24"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                                    Edit
                                </button>
        ...
        <!-- ==================== FACULTY ==================== -->
        <div class="section-card">
            <div class="section-header" onclick="toggleSection('sec-faculty')">
                <div class="header-left">
                    <svg viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                    Faculty
                </div>
                ...
                <div class="data-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <button class="action-btn edit" onclick="toggleEdit('faculty-edit-<?php echo $row['faculty_id']; ?>')">
                                    <svg viewBox="0 0 24 24"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                                    Edit
                                </button>
        ...
        <!-- ==================== SUBJECTS ==================== -->
        <div class="section-card">
            <div class="section-header" onclick="toggleSection('sec-subjects')">
                <div class="header-left">
                    <svg viewBox="0 0 24 24"><path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"/></svg>
                    Subjects
                </div>
                ...
                <div class="data-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <button class="action-btn edit" onclick="toggleEdit('subject-edit-<?php echo $row['subject_id']; ?>')">
                                    <svg viewBox="0 0 24 24"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                                    Edit
                                </button>
        ...
        <!-- ==================== ASSIGNMENTS ==================== -->
        <div class="section-card">
            <div class="section-header" onclick="toggleSection('sec-assignments')">
                <div class="header-left">
                    <svg viewBox="0 0 24 24"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg>
                    Assignments
                </div>
                        ...
                        <div class="data-table">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <button class="action-btn edit" onclick="toggleEdit('building-edit-<?php echo $row['building_id']; ?>')">
                                            <svg viewBox="0 0 24 24"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                                            Edit
                                        </button>
                        ...
                        <div class="data-table">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <button class="action-btn edit" onclick="toggleEdit('room-edit-<?php echo $row['room_id']; ?>')">
                                            <svg viewBox="0 0 24 24"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                                            Edit
                                        </button>
        ...
        <!-- ==================== PREFERENCES ==================== -->
        <div class="section-card">
            <div class="section-header" onclick="toggleSection('sec-preferences')">
                <div class="header-left">
            ...
            <div class="section-body collapsed" id="sec-preferences">
                ...
                <div class="preference-grid">
                    ...
                    <div class="preference-card <?php echo $row['preference_level']; ?>">
                        ...
                        <form method="POST" onsubmit="return confirm('Delete this preference?');">
                            <?php csrf_field(); ?>
        ...
        <!-- ==================== UNAVAILABLE ==================== -->
        <div class="section-card">
            <div class="section-header" onclick="toggleSection('sec-unavailable')">
                <div class="header-left">
