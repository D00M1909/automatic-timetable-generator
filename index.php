    ...
    <div class="content-wrapper">
        ...
        <div class="ai-banner">
            <div>
                ...
                <p>Constraint-based scheduling — room, faculty, and workload conflicts are checked automatically, with per-year rules for minor subjects and building continuity.</p>
            </div>
        ...
        <div class="analytics-grid">
            ...
            <div class="analytics-card">
                ...
                <div class="change">Constraint-scored placement</div>
            </div>
        </div>
        ...
        <div class="content-box">
            ...
            <div class="content-box-body">
                ...
                <?php endif; ?>
                <p style="margin-top:16px;font-size:13px;color:#888;">See <a href="demo.php">How It Works</a> for what the scheduling engine actually checks.</p>
            </div>
        </div>
    </div>
</body>
